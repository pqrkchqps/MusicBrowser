...
#
#  (c) Checkout dartium_tools (with this script):
#      > svn co svn://svn.chromium.org/multivm/trunk/tools dartium_tools
#
...
REPOSITORY_INFO = {
    'webkit': (
        'http://src.chromium.org/multivm/trunk/webkit',
        'http://src.chromium.org/viewvc/multivm/trunk/webkit?view=rev&revision=%s'),
    'tools': (
        'http://src.chromium.org/multivm/trunk/tools',
        'http://src.chromium.org/viewvc/multivm/trunk/tools?view=rev&revision=%s'),
}
